...
def index():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if candidates and 'content' in candidates[0]:
                        ...
                        return render_template('result.html', filename=filename, result=result_html, is_pdf=(ext == 'pdf'))
                    else:
            ...
            flash("Faqat rasm va PDF fayllari ruxsat etilgan! (png, jpg, jpeg, gif, webp, pdf)", "error")
            return redirect(request.url)
